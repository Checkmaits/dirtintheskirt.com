    ...
    <div class="d-flex flex-column align-items-center justify-content-center">
      <div class="half-width text-center" style="padding-top: 80px">
        ...
        <div class="d-flex align-items-center justify-content-center gap-2">
          <a
            href="https://silvercoco.ca/wp-content/uploads/2025/04/Copy-of-DITS-Sponsorship-Deck-2025.pdf"
            class="btn btn-outline-primary-light mt-4"
          >
            View Sponsorship PDF
          </a>
        </div>
      </div>
    </div>
